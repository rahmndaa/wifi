...
}); // <-- Penutup group keuangan yang benar ada di sini!

// ODC & ODP (Admin) -> Berada di luar prefix keuangan
Route::resource('admin/odc', OdcController::class)->names('admin.odc');
Route::resource('admin/odp', OdpController::class)->names('admin.odp');
Route::post('/admin/odp/{id}/pelanggan', [OdpController::class, 'storePelanggan'])->name('admin.odp.storePelanggan');
Route::delete('/admin/pelanggan/{id}/keluarkan', [OdpController::class, 'hapusPelanggan'])->name('admin.odp.hapusPelanggan');
