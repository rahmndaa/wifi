    ...
    <div class="page-inner">
        ...
        <form action="{{ route('admin.keuangan.index') }}" method="GET" class="mb-4">
            <div class="row mb-3">
                ...
                <div class="col-md-1 d-grid">
                    <label class="form-label">&nbsp;</label>
                    <a href="{{ route('admin.keuangan.export', ['dari' => request('dari'), 'sampai' => request('sampai')]) }}" class="btn btn-success btn-sm">
                        Export
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-stats card-round 
                    @if($balance >= 0) bg-success text-white shadow-lg 
                    @else bg-danger text-white shadow-lg 
                    @endif">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    <p class="card-category text-white">Balance</p>
